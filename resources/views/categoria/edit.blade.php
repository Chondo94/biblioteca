...
<html lang="es" dir="ltr">
  ...
  <body>
    ...
    <form method="post" action="{{ route('categoria.update', $categoria->id) }}">
        ...
        <div class="field">
          <div class="control">
            <input type="text" name="descripcion" class="input is-primary is-large has-text-centered is-rounded" required maxlength="250" placeholder="Descripcion" value="{{ $categoria->descripcion }}"><br>
          </div>
        </div>
